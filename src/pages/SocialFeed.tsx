...
const SocialFeed = () => {
  ...
  return (
    <div className="min-h-screen pb-4 relative">
      ...
      <section className="max-w-3xl mx-auto px-4 py-6">
        <div className="flex gap-4 overflow-x-auto pb-2 scrollbar-hide">
          <div className="flex flex-col items-center gap-2 min-w-fit">
            <div className="w-20 h-20 rounded-full bg-gradient-primary p-1 cursor-pointer">
          ...
          {mockSocialPosts.slice(0, 5).map((post) => (
            <div key={post.id} className="flex flex-col items-center gap-2 min-w-fit">
              <div className="w-20 h-20 rounded-full bg-gradient-accent p-1 cursor-pointer animate-glow">
                <img
                  src={post.avatar}
                  alt={post.username}
      ...
      {/* Feed */}
      <main className="max-w-3xl mx-auto px-4 space-y-6 pb-8">
        {posts.map((post) => (
            ...
            <div className="p-4 space-y-3">
              ...
              <div className="flex items-center gap-2 pt-2">
                <Input
                  ...
                  className="h-10 bg-background/50 border-none"
                />
